...
import 'package:test_all/cubit/cubit.dart';
...
void main() async {
  ...
  runApp(
    BlocProvider(
        create: (BuildContext context) => AlarmCubit()..getDailyTable()..getAlertTable(),
...
// this var to to define teacher in main table
  ...
  List<Map<String, String>> teacherNameArabic = [
    ...
    {'arabic': "عبدالعزيز القلاف", "english": "aziz"},
  ];
  ...
  void initState() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (Timer timer) {
      setState(() {
        ...
        // currentTime = DateFormat('HH:mm:ss').format(DateTime.now());
        if (AlarmCubit.get(context).currentDay !=
            DateFormat('EEEE').format(DateTime.now())) {
          AlarmCubit.get(context).currentDay =
              DateFormat('EEEE').format(DateTime.now());

          AlarmCubit.get(context).getDailyTable();
        } // get alert table here
       //R AlarmCubit.get(context).getAlertTable();

        for (var element in AlarmCubit.get(context).dailyTable) {
          if (element.time == currentTime) {
            ...
            players
                .setUrl(
                    'https://firebasestorage.googleapis.com/v0/b/school-alarm-40467.appspot.com/o/sound%2Fring.wav?alt=media&token=c24cec4a-6d82-47a1-b25f-5587203345c3&_gl=1*4y1vng*_ga*MTUyOTA1NDg4Ny4xNjg1MzA3NTc5*_ga_CW55HF8NVT*MTY4NjAwMjcxNy42LjEuMTY4NTkwNzczOS4wLjAuMA..')
                .then((value) => players.play());
    ...
    AlarmCubit.get(context).dailyTable = ourTable
        .where((element) => element.day == AlarmCubit.get(context).currentDay)
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AlarmCubit, AlarmStatus>(
                ...
                headerSliverBuilder:
                  ...
                  return [
                    SliverAppBar(
                      backgroundColor: Colors.teal,
                      elevation: 20,
                      title: const Text('School Alarm'), //department
                      actions: [
                        Card(
                          child: IconButton(
                              onPressed: () {
                            ...
                            onPressed: () {
                              FirebaseFirestore.instance
                                ...
                                for (var value in element.docs) {
                                  alertData
                                      .add(SchoolAlert.formJson(value.data()));
                                }
                              });
                            },
                          ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                            ...
                            ? Row(
                                ...
                                children: [
                                  ...
                                  partContainer(
                                    ...
                                    Text('قسم ',
                                        style:
                                            GoogleFonts.changa(fontSize: 25)),
                                    Text('الحاسوب',
                                        style:
                                            GoogleFonts.changa(fontSize: 25)),
                                  )
                        ...
                        cubit.dailyTable.isNotEmpty
                            ? GridView.builder(
                                shrinkWrap: true,
                                itemCount: cubit.dailyTable.length,
                                gridDelegate:
                                    SliverGridDelegateWithFixedCrossAxisCount(
                                  crossAxisCount: kWidth > 1500
                                      ? cubit.dailyTable.length
                                      : kWidth < 700
                                          ? 2
                                          : 5,
                                  crossAxisSpacing: 5,
                                      ...
                                      showDialog(
                                          ...
                                          builder: (context) {
                                            return StatefulAlert(
                                              ...
                                              day: cubit.dailyTable[index].day,
                                              classNumber:
                                                  cubit.dailyTable[index].index,
                                              classTime:
                                                  cubit.dailyTable[index].time,
                                              teacherImage:
                                                  cubit.dailyTable[index].image,
                                              classRemineTime:
                                                  cubit.dailyTable[index].rTime,
                                            );
                                          });
                                    },
                                    child: SizedBox(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                cubit.dailyTable[index].teacher,
                                                style: GoogleFonts.oswald(
                                                    fontSize: 25),
                                              ),
                                              Flexible(
                            ...
                            : state is GetDailyTableLoadingStates?const  CircularProgressIndicator(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            //                   children: [
                            //                     Text(
                            //                       cubit.dailyTable.length > currentIndex + 1
                                        ...
                                        child: CircleAvatar(
                                          ...
                                          backgroundImage:
                                              cubit.dailyTable.length >
                                                      currentIndex + 1
                                                  ? AssetImage(
                                                      'images/${cubit.dailyTable[currentIndex + 1].image}',
                                                    )
                                                  : const AssetImage(
                                                      'images/checkbox.png'),
                                        )),
                        ...
                        alertData.isNotEmpty
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  image: DecorationImage(
                                                      image: AssetImage(
                                                        'images/${alertData[index].sender}.jpg',
                                                      ),
                                                      fit: BoxFit.fill)),
                                            ),
                                            Expanded(
                            ...
                            : state is GetAlertLoadingStates?const CircularProgressIndicator(
                          color: Colors.amberAccent,
                        ):  const Text('no alert'),
                        // SizedBox(
                        //   height: 150,
                        ...
                        //                         decoration: BoxDecoration(
                        //                           color: Colors.red,
                        //                           image: DecorationImage(image: AssetImage('images/${alertData[index].sender}.jpg',)
                        //                             , fit: BoxFit.fill
                        //                           )
                        //                         ),
                        //
...
class StatefulAlert extends StatelessWidget {
  const StatefulAlert({
    super.key,
      ...
      return AlertDialog(
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              TextFormAlarm(
                  controller: classTodayController..text = day,
                  label: 'اليوم',
                  password: false,
              ...
              TextFormAlarm(
                  ...
                  alert: 'Enter class number'),
              TextFormAlarm(
                  controller: classTitleController..text = classTitle,
                  label: 'الصف',
                  password: false,
                  alert: 'Enter class number'),
              TextFormAlarm(
                  controller: classTeacherController..text = classTeacher,
                  label: 'المعلم',
                  password: false,
                  alert: 'Enter class number'),
              TextFormAlarm(
                  controller: classTimeController..text = classTime,
                  label: 'التوقيت',
                  password: false,
                  alert: 'Enter class number'),
              TextFormAlarm(
                  controller: classTeacherImageController..text = teacherImage,
                  label: 'صورة المعلم',
                  password: false,
                  alert: 'Enter class number'),
              TextFormAlarm(
                  controller: classTimeRemineController
                    ..text = classRemineTime.toString(),
                  label: 'وقت الحصة',
                  password: false,
                  alert: 'Enter class number'),
              MaterialButton(
